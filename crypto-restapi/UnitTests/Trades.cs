...
namespace crypto_restapi.UnitTests
{
    public class Trades
    {
        ...
        {
            // Arrange
            var request = new HttpRequestMessage(HttpMethod.Get, "trades");
        ...
        {
            // Arrange
            var request = new HttpRequestMessage(HttpMethod.Put, "trades");
            // Set request content if needed
        ...
        {
            // Arrange
            var request = new HttpRequestMessage(HttpMethod.Delete, "trades");
