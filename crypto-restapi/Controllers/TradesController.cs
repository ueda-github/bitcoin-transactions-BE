...
namespace crypto_restapi.Controllers
{
	...
	public class TradesController : ControllerBase
	{
		...
		public TradesController(cryptocurrency_integrationContext context, IConfiguration config)
		{
			_context = context;
		...
		{
			var client = new RestClient("http://rest-sandbox.coinapi.io/v1/trades/latest");
